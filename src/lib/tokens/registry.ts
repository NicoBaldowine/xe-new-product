...
export const TOKENS: TokenDef[] = [
  ...
  { name: "text-stays-white", cssVar: "--xe-text-stays-white", category: "content", type: "color", light: "#ffffff", dark: "#ffffff", description: "Always white (e.g. text on photos / CTAs).", themeKeys: ["--color-content-white"] },
  ...
  { name: "size-xs", cssVar: "--xe-size-xs", category: "typography", type: "dimension", light: "12px", description: "Caption / eyebrow / badge size (12px).", themeKeys: ["--text-xs"] },
  { name: "size-xs-lh", cssVar: "--xe-size-xs-lh", category: "typography", type: "dimension", light: "16px", description: "xs line-height.", themeKeys: ["--text-xs--line-height"] },
  { name: "size-sm", cssVar: "--xe-size-sm", category: "typography", type: "dimension", light: "14px", description: "Body small — list rows, secondary text (14px).", themeKeys: ["--text-sm"] },
  { name: "size-sm-lh", cssVar: "--xe-size-sm-lh", category: "typography", type: "dimension", light: "20px", description: "sm line-height.", themeKeys: ["--text-sm--line-height"] },
  { name: "size-base", cssVar: "--xe-size-base", category: "typography", type: "dimension", light: "16px", description: "Body — default paragraph (16px).", themeKeys: ["--text-base"] },
  { name: "size-base-lh", cssVar: "--xe-size-base-lh", category: "typography", type: "dimension", light: "24px", description: "base line-height.", themeKeys: ["--text-base--line-height"] },
  { name: "size-lg", cssVar: "--xe-size-lg", category: "typography", type: "dimension", light: "18px", description: "Body large / small heading (18px).", themeKeys: ["--text-lg"] },
  { name: "size-lg-lh", cssVar: "--xe-size-lg-lh", category: "typography", type: "dimension", light: "28px", description: "lg line-height.", themeKeys: ["--text-lg--line-height"] },
  { name: "size-xl", cssVar: "--xe-size-xl", category: "typography", type: "dimension", light: "20px", description: "Title h4 — small section headings (20px).", themeKeys: ["--text-xl"] },
  { name: "size-xl-lh", cssVar: "--xe-size-xl-lh", category: "typography", type: "dimension", light: "28px", description: "xl line-height.", themeKeys: ["--text-xl--line-height"] },
  { name: "size-2xl", cssVar: "--xe-size-2xl", category: "typography", type: "dimension", light: "24px", description: "Title h3 — card headings, greetings (24px).", themeKeys: ["--text-2xl"] },
  { name: "size-2xl-lh", cssVar: "--xe-size-2xl-lh", category: "typography", type: "dimension", light: "32px", description: "2xl line-height.", themeKeys: ["--text-2xl--line-height"] },
  { name: "size-3xl", cssVar: "--xe-size-3xl", category: "typography", type: "dimension", light: "30px", description: "Title h2 — balances, big numbers (30px).", themeKeys: ["--text-3xl"] },
  { name: "size-3xl-lh", cssVar: "--xe-size-3xl-lh", category: "typography", type: "dimension", light: "34px", description: "3xl line-height.", themeKeys: ["--text-3xl--line-height"] },
  { name: "size-4xl", cssVar: "--xe-size-4xl", category: "typography", type: "dimension", light: "36px", description: "Title h1 — hero / display (36px).", themeKeys: ["--text-4xl"] },
  { name: "size-4xl-lh", cssVar: "--xe-size-4xl-lh", category: "typography", type: "dimension", light: "36px", description: "4xl line-height.", themeKeys: ["--text-4xl--line-height"] },

  // ── semantic text styles (size + line-height; → text-h1.. / text-body.. utilities) ──
  { name: "title-h1", cssVar: "--xe-title-h1", category: "textStyle", type: "dimension", light: "36px", description: "Title H1 — hero / display.", themeKeys: ["--text-h1"] },
  { name: "title-h1-lh", cssVar: "--xe-title-h1-lh", category: "textStyle", type: "dimension", light: "40px", description: "Title H1 line-height.", themeKeys: ["--text-h1--line-height"] },
  { name: "title-h2", cssVar: "--xe-title-h2", category: "textStyle", type: "dimension", light: "30px", description: "Title H2 — big numbers / balances.", themeKeys: ["--text-h2"] },
  { name: "title-h2-lh", cssVar: "--xe-title-h2-lh", category: "textStyle", type: "dimension", light: "36px", description: "Title H2 line-height.", themeKeys: ["--text-h2--line-height"] },
  { name: "title-h3", cssVar: "--xe-title-h3", category: "textStyle", type: "dimension", light: "24px", description: "Title H3 — card headings / greetings.", themeKeys: ["--text-h3"] },
  { name: "title-h3-lh", cssVar: "--xe-title-h3-lh", category: "textStyle", type: "dimension", light: "32px", description: "Title H3 line-height.", themeKeys: ["--text-h3--line-height"] },
  { name: "title-h4", cssVar: "--xe-title-h4", category: "textStyle", type: "dimension", light: "20px", description: "Title H4 — small section headings.", themeKeys: ["--text-h4"] },
  { name: "title-h4-lh", cssVar: "--xe-title-h4-lh", category: "textStyle", type: "dimension", light: "28px", description: "Title H4 line-height.", themeKeys: ["--text-h4--line-height"] },
  { name: "body-lg", cssVar: "--xe-body-lg", category: "textStyle", type: "dimension", light: "18px", description: "Body large.", themeKeys: ["--text-body-lg"] },
  { name: "body-lg-lh", cssVar: "--xe-body-lg-lh", category: "textStyle", type: "dimension", light: "28px", description: "Body large line-height.", themeKeys: ["--text-body-lg--line-height"] },
  { name: "body", cssVar: "--xe-body", category: "textStyle", type: "dimension", light: "16px", description: "Body — default paragraph.", themeKeys: ["--text-body"] },
  { name: "body-lh", cssVar: "--xe-body-lh", category: "textStyle", type: "dimension", light: "24px", description: "Body line-height.", themeKeys: ["--text-body--line-height"] },
  { name: "body-sm", cssVar: "--xe-body-sm", category: "textStyle", type: "dimension", light: "14px", description: "Body small — rows / secondary.", themeKeys: ["--text-body-sm"] },
  { name: "body-sm-lh", cssVar: "--xe-body-sm-lh", category: "textStyle", type: "dimension", light: "20px", description: "Body small line-height.", themeKeys: ["--text-body-sm--line-height"] },
  { name: "caption", cssVar: "--xe-caption", category: "textStyle", type: "dimension", light: "12px", description: "Caption / eyebrow.", themeKeys: ["--text-caption"] },
  { name: "caption-lh", cssVar: "--xe-caption-lh", category: "textStyle", type: "dimension", light: "16px", description: "Caption line-height.", themeKeys: ["--text-caption--line-height"] },
