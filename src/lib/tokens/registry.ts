...
export const TOKENS: TokenDef[] = [
  ...
  // Solid status fills carry default / hover / pressed (same state pattern as
  // action) for status buttons & emblems; hover lifted, pressed deepened.
  ...
  { name: "surface-success-hover", cssVar: "--xe-surface-success-hover", category: "surface", type: "color", light: "#37b063", dark: "#37b063", description: "Success fill hover.", themeKeys: ["--color-surface-success-hover"], pairWith: "content-stays-white" },
  { name: "surface-success-pressed", cssVar: "--xe-surface-success-pressed", category: "surface", type: "color", light: "#138f41", dark: "#138f41", description: "Success fill pressed.", themeKeys: ["--color-surface-success-pressed"], pairWith: "content-stays-white" },
  ...
  { name: "surface-warning-hover", cssVar: "--xe-surface-warning-hover", category: "surface", type: "color", light: "#d19a27", dark: "#d19a27", description: "Warning fill hover.", themeKeys: ["--color-surface-warning-hover"], pairWith: "content-stays-white" },
  { name: "surface-warning-pressed", cssVar: "--xe-surface-warning-pressed", category: "surface", type: "color", light: "#b27904", dark: "#b27904", description: "Warning fill pressed.", themeKeys: ["--color-surface-warning-pressed"], pairWith: "content-stays-white" },
  ...
  { name: "surface-danger-hover", cssVar: "--xe-surface-danger-hover", category: "surface", type: "color", light: "#e14444", dark: "#e14444", description: "Danger fill hover.", themeKeys: ["--color-surface-danger-hover"], pairWith: "content-stays-white" },
  { name: "surface-danger-pressed", cssVar: "--xe-surface-danger-pressed", category: "surface", type: "color", light: "#c22121", dark: "#c22121", description: "Danger fill pressed.", themeKeys: ["--color-surface-danger-pressed"], pairWith: "content-stays-white" },
